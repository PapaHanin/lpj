...
export const INITIAL_BANGUNAN_LIST: BangunanProyek[] = [
  {
    ...
    kode: 'BG-01',
    lokasi: 'JL. NELAYAN DUSUN 1 BAMBANIPA, DESA PALASA',
...
export const DEFAULT_ABSEN_MINGGU_4: AbsenMingguanTukang = {
  ...
  namaSekolah: 'SDN INPRES 5 PALASA',
  lokasi: 'JL. NELAYAN DUSUN 1 BAMBANIPA, DESA PALASA',
  periodeKe: 1,
  mingguKe: 1,
  hariTanggal: '14 s.d 27 Agustus 2023',
  namaKepalaSekolah: 'NURWAHDA, S.Pd.SD',
  nipKepalaSekolah: '197012271993022004',
  namaBendahara: 'RAHMAWATI, S.Pd',
  nipBendahara: '197906012014092001',
  hariLibur: ['m1_7', 'm2_7'],
  pekerja: [
    {
      id: 'tk-1',
